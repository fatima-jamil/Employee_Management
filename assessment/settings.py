...
SECRET_KEY = '&qu!ml+)54qb1z*_8112x#92(2ao@9b)pc-@f$z@(au%=&tb-q'
...
MONGO_URI = os.getenv("DB_HOST")   # your connection string
...
# MONGO_DB_NAME = os.getenv("MONGO_DB_NAME", "assessment_db")
